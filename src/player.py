...
@dataclass
class Player:
    name:str;age:int;stats:PlayerStats;traits:list[Trait]=field(default_factory=list);nationality:str='KOR';position:str='SS';bats_throws:str='R/R';team:str|None=None;roster_level:str='HIGH_SCHOOL';fatigue:float=0.;injury:InjuryStatus|None=None;form:str='normal';form_games_remaining:int=0;seasons:list[SeasonRecord]=field(default_factory=list);high_school_stats:BattingLine=field(default_factory=BattingLine);growth_history:list[dict[str,object]]=field(default_factory=list);injury_history:list[dict[str,object]]=field(default_factory=list);trait_history:list[dict[str,object]]=field(default_factory=list);team_history:list[dict[str,object]]=field(default_factory=list);awards:list[dict[str,object]]=field(default_factory=list);event_history:list[dict[str,object]]=field(default_factory=list);draft_info:dict[str,object]|None=None;debut_year:int|None=None;retirement_age:int|None=None;initial_talent:int|None=None;development_profile:str='normal';season_modifiers:dict[str,int]=field(default_factory=dict);breakthrough_affinity:float=1.0
