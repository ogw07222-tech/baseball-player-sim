"""Career/date integration for the production full-game provider.
...
class CareerGameAdvanceProvider:
    ...
    def __init__(
        ...
        self.game_provider = game_provider or ProductionGameProvider()
...
class ProductionAdvanceService:
    """1-game / 1-week / 1-month production backbone for a CareerEngine."""
    ...
    def __init__(
        ...
        *,
        ...
        self.orchestrator = AdvanceOrchestrator(
            state,
            self.schedule,
            self.game_provider,
