...
def main():
 p=argparse.ArgumentParser(); p.add_argument('--pa',type=int,default=50000); p.add_argument('--games',type=int,default=500); p.add_argument('--seed',type=int,default=20260911); a=p.parse_args()
